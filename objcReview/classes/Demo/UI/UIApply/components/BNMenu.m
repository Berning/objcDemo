...
@interface BNMenu ()<UIScrollViewDelegate>
...
+ (void)controllersSwitchOnController:(UIViewController *)controller superViewType:(BNSuperViewType)superViewType
{
    ...
    BNMenu *switchComponent=[self shareViewControllersSwitch];
...
+ (instancetype)shareViewControllersSwitch
{
    ...
    static BNMenu *_switchComponent;
    dispatch_once(&onceToken, ^{
        _switchComponent=[[BNMenu alloc] init];
    });
